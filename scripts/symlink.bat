...
set "source=E:\Code\Adibags_ByExpansion\build"
set "dest=E:\Games\World of Warcraft\_retail_\Interface\AddOns"

mklink /D "%dest%\AdiBags_ByExpansion" "E:\Code\Adibags_ByExpansion\"
