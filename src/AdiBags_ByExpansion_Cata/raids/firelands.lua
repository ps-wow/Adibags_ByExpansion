...
AddonTable.firelands = {
    ...
    71665,  -- Flametalon of Alysrazor [Mount]
    ...
    71780,  -- zoids-firelit-greatsword
    71779,  -- avools-incendiary-shanker
    ...
    71475,  -- Treads of the Pentitent Man
    ...
    71677,  -- Crown of the Fiery Conqueror (H)
    71684,  -- Crown of the Fiery Protector (H)
    71670,  -- Crown of the Fiery Vanquisher (H)
    71675,  -- Crown of the Fiery Conqueror (N)
    71682,  -- Crown of the Fiery Protector (N)
    71668,  -- Crown of the Fiery Vanquisher (N)
