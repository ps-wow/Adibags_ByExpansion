...
AddonTable.engineering = {
    ...
    10644, -- Recipe: Goblin Rocket Fuel (Crafted by Eng, used by Alchemy)
    10645, -- Gnomish Death Ray
    10646, -- Goblin Sapper Charge
    10713, -- Plans: Inlaid Mithril Cylinder (Crafted by Eng, used by Blacksmithing)
    ...
    18634, -- Gryofreeze Ice Reflector
